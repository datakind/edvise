...
COMPLETION_SUCCESS_MESSAGE = """\
    ...
    Your most recent prediction results are now available in Edvise. Please log in and download them at your earliest convenience. As a reminder, you should have the StudyID appended file from the NSC SFTP to reconnect our inferences to your students and begin supporting those most in need of intervention.
