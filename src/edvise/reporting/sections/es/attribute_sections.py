...
def register_attribute_sections(card, registry):
    """
    Registers all attributes or characteristics of an Edvise model such as its outcome,
    ...
    def outcome():
        """
        Produce section for outcome variable based on config target definition. Edvise has
    ...
    def checkpoint():
        """
        Produce a section for the Edvise checkpoint.
        """
