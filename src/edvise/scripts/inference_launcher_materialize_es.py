#!/usr/bin/env python3
"""ES launcher task: materialize ES (+ optional GenAI) runtime bundle on UC volume."""
...
from edvise.runtime.versioned_inference.tasks.materialize_es import main  # noqa: E402
