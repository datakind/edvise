...
_HARDCODED_SSI_PIPELINES_WORKSPACE_ROOT = (
    "/Workspace/Users/jonathan.nolen@datakind.org/student-success-intervention/pipelines"
)
...
def materialize_legacy_bronze_predict_paths(
    ...
    institution_id = (
        institution_id_raw.strip() if isinstance(institution_id_raw, str) else ""
    )
    ...
    bronze = datasets_raw.get("bronze") if isinstance(datasets_raw, dict) else None
