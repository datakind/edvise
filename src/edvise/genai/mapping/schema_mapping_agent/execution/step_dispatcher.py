...
from ..transformation.utilities import (
    ...
    normalize_gateway_or_developmental_flag,
    normalize_grade,
    normalize_instructional_modality,
    normalize_instructor_appointment,
    normalize_pell,
    normalize_yes_no,
...
def dispatch_step(
    ...
    dispatch = {
        ...
        "normalize_instructional_modality": lambda: normalize_instructional_modality(s),
        "normalize_instructor_appointment": lambda: normalize_instructor_appointment(s),
        "normalize_gateway_or_developmental_flag": lambda: (
            normalize_gateway_or_developmental_flag(s)
        ),
        "normalize_yes_no": lambda: normalize_yes_no(s),
