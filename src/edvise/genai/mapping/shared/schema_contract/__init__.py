"""Public exports for :mod:`edvise.genai.mapping.shared.schema_contract`.

- **Frozen + enriched schema-contract models** — :mod:`edvise.genai.mapping.shared.schema_contract.schemas`
...
- **Load / ``clean_dataset`` / freeze** (raw contract dict, not enriched) —
  :mod:`edvise.genai.mapping.shared.schema_contract.build_from_school_config`, so importing only
